...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	|		ВЫБОР
	|			КОГДА Кнопки.Код ЕСТЬ NULL
	|				ТОГДА """"
	|			ИНАЧЕ Кнопки.Код + "" / "" + Кнопки.НаименованиеКнопки
	|		КОНЕЦ, "" - "") КАК КнопкиСтрокой
	|ИЗ
	|	РегистрСведений.питАктуальныеРецептуры КАК АктРец
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ПЛ_СоответствиеСФронтСистемами КАК Кнопки
	|		ПО АктРец.Номенклатура = Кнопки.Объект
	|ГДЕ
	...
	|СГРУППИРОВАТЬ ПО
	|	АктРец.Рецептура,
	|	АктРец.Рецептура.Номер,
	|	АктРец.Рецептура.Наименование,
	|	АктРец.Номенклатура,
	|	АктРец.Организация,
	|	АктРец.Подразделение";
	...
	Пока Выборка.Следующий() Цикл
		...
		КнопкиФронтСистемы = ?(ПустаяСтрока(Выборка.КнопкиСтрокой), "Не привязана", Выборка.КнопкиСтрокой);
