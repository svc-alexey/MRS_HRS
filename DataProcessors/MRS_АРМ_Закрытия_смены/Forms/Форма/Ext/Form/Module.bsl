...
Процедура ОбработатьРасшифровку(Расшифровка)
	...
	Если ТипЗнч(Данные) = Тип("Структура") Тогда
		...
		Если Данные.Свойство("Значение") Тогда
			ЗначениеРасшифровки = Данные.Значение;
		Иначе
			Возврат;
		КонецЕсли;
		
	Иначе
		ЗначениеРасшифровки = Данные;
	КонецЕсли;
	
	// Открытие ссылки, если это ссылочный тип
	Если ТипЗнч(ЗначениеРасшифровки) <> Тип("Неопределено") Тогда
...
Функция ДанныеЭлементаРасшифровки(Знач Расшифровка)
	...
	Попытка
		...
		Возврат ДанныеРасшифровки.Элементы[Расшифровка];
