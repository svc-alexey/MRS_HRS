...
Функция СформироватьHTMLВкладкаОсновнаяНаСервере(Знач БазаПодключена)
	...
	Ч = Ч + "<p class=""hint"">Выбрано: <strong>" + HTMLЭкранировать(HTML_ПредставлениеДатыПараметра(параметр_ДатаОткрытия)) + "</strong> - <strong>" + HTMLЭкранировать(HTML_ПредставлениеДатыПараметра(параметр_ДатаОтключения)) + "</strong></p>";
