...
Процедура ДобавитьСтраницуКостПродаж(Форма)
	...
	НоваяСтраница = Форма.Элементы.Добавить("MRS_СтраницаКостПродаж", Тип("СтраницаФормы"), Форма.Элементы.ОсновнаяПанель);
	НоваяСтраница.Заголовок = "Кост продаж";
	НоваяСтраница.Подсказка = "Кост продаж";
	...
	Декорация.ЦветТекста = ЦветаСтиля.ЦветМикротекста;
	...
	ТаблицаКостПродаж.АвтоДобавлениеНовойСтроки = Истина;
	ТаблицаКостПродаж.РазрешитьНачалоПеретаскивания = Истина;
	ТаблицаКостПродаж.РазрешитьПеретаскивание = Истина;
