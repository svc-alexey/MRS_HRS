...
Функция ПодготовитьСоответствиеНоменклатураЦена(СтруктураПараметров) Экспорт
	...
	// Для расчета стоимости позиции меню в симфони (13 приоритетов).
	Если РассчетПоСебестоимостиСтруктура <> Неопределено Тогда
		...
		|	МАКСИМУМ(СтоимостьТоваров.Стоимость) КАК Стоимость
		...
		|			И СтоимостьТоваров.АналитикаУчетаНоменклатуры.МестоХранения = &Склад
		...
		|ГДЕ
		|	СтоимостьТоваров.АналитикаУчетаНоменклатуры.МестоХранения = &Склад
		|	И СтоимостьТоваров.Стоимость <> 0
		|
		|СГРУППИРОВАТЬ ПО
		...
		|
		|////////////////////////////////////////////////////////////////////////////////
		|// Список номенклатуры из параметров
		|ВЫБРАТЬ
		...
		|	ВТ_СписокНоменклатуры.Номенклатура.ЕдиницаИзмерения КАК Упаковка,
		|	ЕСТЬNULL(КурсыВалютСрезПоследних.Курс, 1) КАК Курс,
		|	ЕСТЬNULL(КурсыВалютСрезПоследних.Кратность, 1) КАК Кратность
		|ИЗ
		...
		|		ПО ВТ_СписокНоменклатуры.Номенклатура = ВТ_СтоимостьПоСкладу.Номенклатура
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_СтоимостьПоПодразделению КАК ВТ_СтоимостьПоПодразделению
		|		ПО ВТ_СписокНоменклатуры.Номенклатура = ВТ_СтоимостьПоПодразделению.Номенклатура
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_СтоимостьПоОрганизации КАК ВТ_СтоимостьПоОрганизации
		|		ПО ВТ_СписокНоменклатуры.Номенклатура = ВТ_СтоимостьПоОрганизации.Номенклатура
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_ЗакупкиТекМесяцСклад КАК ВТ_ЗакупкиТекМесяцСклад
		|		ПО ВТ_СписокНоменклатуры.Номенклатура = ВТ_ЗакупкиТекМесяцСклад.Номенклатура
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_ЗакупкиТекМесяцПодразделение КАК ВТ_ЗакупкиТекМесяцПодразделение
		|		ПО ВТ_СписокНоменклатуры.Номенклатура = ВТ_ЗакупкиТекМесяцПодразделение.Номенклатура
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_ЗакупкиТекМесяцОрганизация КАК ВТ_ЗакупкиТекМесяцОрганизация
		|		ПО ВТ_СписокНоменклатуры.Номенклатура = ВТ_ЗакупкиТекМесяцОрганизация.Номенклатура
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_ЗакупкиПредМесяцСклад КАК ВТ_ЗакупкиПредМесяцСклад
		|		ПО ВТ_СписокНоменклатуры.Номенклатура = ВТ_ЗакупкиПредМесяцСклад.Номенклатура
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_ЗакупкиПредМесяцПодразделение КАК ВТ_ЗакупкиПредМесяцПодразделение
		|		ПО ВТ_СписокНоменклатуры.Номенклатура = ВТ_ЗакупкиПредМесяцПодразделение.Номенклатура
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_ЗакупкиПредМесяцОрганизация КАК ВТ_ЗакупкиПредМесяцОрганизация
		|		ПО ВТ_СписокНоменклатуры.Номенклатура = ВТ_ЗакупкиПредМесяцОрганизация.Номенклатура
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_СтоимостьТолькоНоменклатура КАК ВТ_СтоимостьТолькоНоменклатура
		|		ПО ВТ_СписокНоменклатуры.Номенклатура = ВТ_СтоимостьТолькоНоменклатура.Номенклатура
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_ЗакупкиТекМесяцТолькоНоменклатура КАК ВТ_ЗакупкиТекМесяцТолькоНоменклатура
		|		ПО ВТ_СписокНоменклатуры.Номенклатура = ВТ_ЗакупкиТекМесяцТолькоНоменклатура.Номенклатура
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_ЗакупкиПредМесяцТолькоНоменклатура КАК ВТ_ЗакупкиПредМесяцТолькоНоменклатура
		|		ПО ВТ_СписокНоменклатуры.Номенклатура = ВТ_ЗакупкиПредМесяцТолькоНоменклатура.Номенклатура";
