...
Процедура ПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка) Экспорт
	Если Форма.ИмяФормы = "Документ.УстановкаЦенНоменклатуры.Форма.ФормаДокумента" Тогда
		...
		УИДЕЛМА = Форма.Элементы.Добавить("URLProcess", Тип("ПолеФормы"), Форма.Элементы.ГруппаПодвал);	
		УИДЕЛМА.Вид = ВидПоляФормы.ПолеНадписи;
		УИДЕЛМА.ПутьКДанным = "URLProcess";
		УИДЕЛМА.ТолькоПросмотр = Истина;
		УИДЕЛМА.Заголовок = "Процесс ЕЛМА";
