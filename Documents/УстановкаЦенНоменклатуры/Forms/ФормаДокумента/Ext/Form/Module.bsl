...
Функция ПоставитьПозицииВОчередьSimphony()
	...
	Возврат MRS_ИнтеграцияSimphonyСервер.ПоставитьВОчередьВыгрузкиНаСервереПриИзмененииЦен(ЭтотОбъект);
...
Функция ПроверитьЦеныНижеКостаНаСервере()
	...
	Возврат MRS_ИнтеграцияЕЛМАСервер.ПроверитьЦеныНижеКоста(Объект.Ссылка);
