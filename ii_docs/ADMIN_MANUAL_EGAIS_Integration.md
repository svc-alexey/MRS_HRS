...
2. **Штрихкоды продукции:**
   - Двусторонняя синхронизация штрихкодов между 1С и Simphony
...
### 2.2. Добавление штрихкодов

Для каждой алкогольной позиции необходимо добавить штрихкоды в регистр сведений **"ШтрихкодыНоменклатуры"**:
...
| 05.02.2026 14:30:17 | EGAIS_BARCODES | Выгружено | 0 | Добавлено: 3, Удалено: 1. Штрихкоды синхронизированы |
