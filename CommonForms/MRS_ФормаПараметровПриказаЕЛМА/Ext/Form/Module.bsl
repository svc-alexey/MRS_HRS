...
Процедура ЗагрузитьЗначенияПоУмолчанию(ВидЦены)
	...
	Тема = СтрШаблон("Об утверждении прейскуранта цен на блюда на точке/точках питания %1", СтруктураДанных.ТочкаПродаж);
	Цель = СтрШаблон("В целях организации сбыта товаров, реализуемых на точке/точках питания %1", СтруктураДанных.ТочкаПродаж);
