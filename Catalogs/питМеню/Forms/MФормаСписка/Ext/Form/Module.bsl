...
// Команда откртия формы управления очередью выгрузки в Simphony.
// Предоставляет выбор режима: выделенные, группа или все меню.
//
// Параметры:
//  Команда - КомандаФормы - выполняемая команда
...
// Команда откртия формы мониторинга выгрузки в Simphony
// Предоставляет выбор режима: выделенные, группа или все меню.
//
// Параметры:
//  Команда - КомандаФормы - выполняемая команда
...
Процедура УстановитьОтборПоВыбранномуВидуМеню()
	...
	// Сохраняем текущего родителя для создания новых элементов
	Элементы.Список.ТекущийВладелец = ОтборВладелец;
