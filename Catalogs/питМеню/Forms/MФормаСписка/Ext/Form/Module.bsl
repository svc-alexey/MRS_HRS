...
Перем ФлагИзмененияОтбораДерева;		// Флаг для предотвращения циклического вызова при изменении отбора
...
Процедура ПриОткрытии(Отказ)
	...
	// Инициализируем флаг для предотвращения циклических вызовов
...
Процедура ДеревоПриАктивизацииСтроки(Элемент)
	...
	Если ФлагИзмененияОтбораДерева = Истина Тогда
		Возврат;
	КонецЕсли;
	...
	Попытка
		...
		ОтборыСписковКлиентСервер.ИзменитьЭлементОтбораСписка(Список, "Родитель", ТекущиеДанные, ЗначениеЗаполнено(ТекущиеДанные));
